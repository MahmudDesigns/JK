...
export default function WhatsAppBadge() {
  ...
  return (
    ...
    >
      {/* Label */}
      <div
        className={`absolute right-full mr-3 top-1/2 -translate-y-1/2 whitespace-nowrap bg-white text-oxford text-xs font-semibold px-4 py-2.5 rounded-xl shadow-lg border border-slate-100 transition-all duration-300 ${
